        ...
        if (itemstack.getItem() instanceof ArmorItem) {
            ...
            if (armoritem.getEquipmentSlot() == pSlot) {
                ...
                if (armoritem instanceof net.minecraft.world.item.DyeableLeatherItem) {
                    ...
                    this.renderModel(pPoseStack, pBuffer, p_117123_, flag1, model, f, f1, f2, this.getArmorResource(itemstack, pSlot, null));
                    this.renderModel(pPoseStack, pBuffer, p_117123_, flag1, model, 1.0F, 1.0F, 1.0F, this.getArmorResource(itemstack, pSlot, "overlay"));
                } else {
                    this.renderModel(pPoseStack, pBuffer, p_117123_, flag1, model, 1.0F, 1.0F, 1.0F, this.getArmorResource(itemstack, pSlot, null));
                }
            }
