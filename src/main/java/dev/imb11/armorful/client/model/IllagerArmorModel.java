...
public class IllagerArmorModel<T extends AbstractIllager> extends HumanoidModel<T> {
    ...
    public static LayerDefinition createOuterArmorLayer() {
        MeshDefinition modelData = HumanoidModel.createMesh(new CubeDeformation(1.0F), 0.0F);
        PartDefinition modelPartData = modelData.getRoot();

        modelPartData.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -10.0F, -4.0F,
