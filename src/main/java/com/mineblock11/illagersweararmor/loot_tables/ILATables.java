...
public class ILATables {
    public static final Identifier ILLAGER_HELMET = new Identifier(IllagersWearArmor.MODID,
            "entities/illager_helmet");
    public static final Identifier ILLAGER_CHEST = new Identifier(IllagersWearArmor.MODID,
            "entities/illager_chestplate");
    public static final Identifier ILLAGER_LEGGINGS = new Identifier(IllagersWearArmor.MODID,
            "entities/illager_legs");
    public static final Identifier ILLAGER_FEET = new Identifier(IllagersWearArmor.MODID,
    ...
    public static LootContextType register(String p_81429_, Consumer<LootContextType.Builder> p_81430_) {
        ...
        Identifier Identifier = new Identifier(IllagersWearArmor.MODID, p_81429_);
